class Patient:
    ...
    def get_full_name(self):
        ...
        print(self.age) #print(age) will give an error because age is not define, use class variable self.age
        return full_name
...
def main():
    ...
    # new_patient.first_name = "Isha"
    # new_patient.last_name = "Paranjape"
    new_patient.tests.append(("HDL", 100))
    print(new_patient.first_name)
    print(new_patient.last_name)
    print(new_patient.tests)
    print(new_patient.get_full_name()) #ignore "self" when calling function
